...
/** 
 * 说明：vmes_equipment_maintainTask_detail:设备保养任务明细表 实体类
 * @author 陈刚 自动生成
 * @date 2019-07-29
 */
@TableName("vmes_equipment_maintainTask_detail")
public class EquipmentMaintainTaskDetail implements Serializable {
