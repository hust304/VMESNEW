...
public interface DepartmentExcelService {
    ...
    String checkColumnImportExcel(List<DeptExcelEntity> objectList,
                                         String companyId,
                                         Integer index,
                                         Integer maxShowRow);

    String checkExistImportExcelBySelf(List<DeptExcelEntity> excelList,Integer index, Integer maxShowRow);
    String checkExistImportExcelByDatabase(
            List<DeptExcelEntity> excelList,
            String companyId,
            Integer index,
            Integer maxShowRow);

    void addImportExcelByList(List<DeptExcelEntity> excelList,
                                String cuser,
                                String companyId);
}
