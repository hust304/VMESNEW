...
public interface MobileWarehouseCheckService {
    ...
    //获得盘点任务详细信息
    ResultModel findWarehouseCheckByAduiting(PageData pd) throws Exception;

    //获得盘点任务详细信息
    ResultModel findWarehouseCheckByAduited(PageData pd) throws Exception;
    ...
    ResultModel listWarehouseCheckByState(PageData pd, Pagination pg) throws Exception;
