...
public interface WarehouseOutExecuteService {
    ...
    */
    ...
    ResultModel executeWarehouseOutExecuteByWC(PageData pageData) throws Exception;

    ResultModel auditPassWarehouseOutScrapByWC(PageData pageData)  throws Exception;
