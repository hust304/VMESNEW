...
public class Consumer {
     ...
     * 2. 修改订单明细锁库字段
     *
     * @param orderDtlId  订单明细id
     *
     */
    @JmsListener(destination = "sale.orderDetail.ProductLockcount.queue")
    public void receiveProductLockcount (String orderDtlId) throws Exception {
        //System.out.println("ProductLockcount 收到的报文为:" + orderDtlId);
        if (orderDtlId == null || orderDtlId.trim().length() == 0) {return;}
