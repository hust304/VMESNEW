    ...
    */
    ...
    public String selectById(@PathVariable("id") String id) {
        ...
        try {
            ...
            result.put("code",0);
            result.put("msg","执行成功！");
            result.put("result",department);
        }catch (Exception e){
            e.printStackTrace();
            StringWriter sw = new StringWriter();
            e.printStackTrace(new PrintWriter(sw));
            logger.error("################department/selectById################# 执行异常:"+sw.toString());
            result.put("code",1);
            result.put("msg","执行异常！");
    ...
    */
    ...
    public String findById() {
        ...
        try {
            ...
            StringWriter sw = new StringWriter();
            e.printStackTrace(new PrintWriter(sw));
            logger.error("################department/findById################# 执行异常:"+sw.toString());
            result.put("code",1);
            result.put("msg","执行异常！");
            result.put("result",sw.toString());
        }
    ...
    */
    ...
    public void excelExport() {
        ...
        try {
                ...
                StringWriter sw = new StringWriter();
                e.printStackTrace(new PrintWriter(sw));
                logger.error("################department/excelExport################# 执行异常:"+sw.toString());
            }
