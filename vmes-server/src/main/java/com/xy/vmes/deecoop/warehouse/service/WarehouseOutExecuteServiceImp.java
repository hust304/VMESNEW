...
//            }
    ...
    @Override
    public ResultModel auditPassWarehouseOutScrapByWC(PageData pageData) throws Exception {
        ResultModel model = new ResultModel();
        ...
        if(mapList!=null&&mapList.size()>0){
            for (Map outDetailMap : mapList) {
                ...
                BigDecimal count = (BigDecimal)outDetailMap.get("count");
                String warehouseProductId = (String)outDetailMap.get("warehouseProductId");
