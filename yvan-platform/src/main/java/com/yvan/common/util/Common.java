...
public class Common {
    ...
    public final static String SYS_MAIL_ADDRESS_A = "662702@qq.com";
...
//    }};
    ...
    public static final Map<String, String> DICTIONARY_MAP = new HashMap<String, String>() {{
        ...
        put("warehouseOutType", "20c09785a7b54ec280d10c988be21929");
            ...
            //外协退货出库 75338f5acdcb40e2ac3fc5a0069229d0
            put("assistRetreatOut", "75338f5acdcb40e2ac3fc5a0069229d0");
